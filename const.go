...
const (
	URL_HTTPS         string = "https://eco.taobao.com/router/rest"
	URL_HTTP          string = "http://gw.api.taobao.com/router/rest"
	Method_SendSMS    string = "alibaba.aliqin.fc.sms.num.send"
	Method_QuerySMS   string = "alibaba.aliqin.fc.sms.num.query"
